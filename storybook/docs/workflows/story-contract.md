...
Important: this contract defines the internal story inventory and testing surfaces. It does not define the reader-facing documentation outline. Docs headings and section order must follow the Figma documentation page.
...
- Figma documentation outline is the source of truth for MDX section headings and order.
- Internal story names (for example `Scale`, `Reference`, `Modes`) should remain implementation labels unless the Figma docs page uses those exact labels.
