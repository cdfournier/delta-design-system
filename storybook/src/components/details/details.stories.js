function createDetailsDocumentation() {
  return `
    <style>
      ...
      .delta-docs .details-specimen {
        display: flex;
        width: min(100%, var(--components-details-item-width));
        align-self: flex-start;
        flex-direction: column;
        gap: var(--components-details-gap);
        padding: var(--components-details-padding);
        border: var(--components-details-border-width) solid var(--components-details-border-color);
        border-radius: var(--components-details-border-radius);
        color: var(--text-default);
      }

      .delta-docs .details-specimen__summary {
        display: flex;
        align-items: center;
        gap: var(--components-details-gap);
        padding: 0;
        ...
        font-size: var(--components-details-summary-font-size);
        line-height: var(--components-details-summary-line-height);
      ...
      .delta-docs .details-specimen__summary::-webkit-details-marker {
        display: none;
      }

      .delta-docs .details-specimen__summary-text {
        flex: 1 1 auto;
      }

      .delta-docs .details-specimen__icon {
        display: inline-flex;
        width: var(--components-details-icon-box-size);
        height: var(--components-details-icon-box-size);
        align-items: center;
        justify-content: center;
        flex: 0 0 auto;
        margin-left: auto;
        padding: var(--components-details-gap);
      }

      .delta-docs .details-specimen__icon svg {
        width: var(--components-details-icon-size);
        height: var(--components-details-icon-size);
        fill: none;
        stroke: currentColor;
        stroke-width: var(--components-details-icon-stroke-width);
        stroke-linecap: round;
        stroke-linejoin: round;
        vector-effect: non-scaling-stroke;
      }

      .delta-docs .details-specimen__body {
        margin: 0;
        color: var(--text-default);
        font-family: var(--font-family-body);
        font-size: var(--components-details-body-font-size);
        line-height: var(--components-details-body-line-height);
      }

      .delta-docs .details-specimen[open] .details-specimen__icon-plus {
        display: none;
      }
    ...
    <article class="delta-docs">
      ...
      <div class="delta-docs__demo details-specimen-shell" aria-label="Details state specimens">
        <div class="details-specimen-grid">
          <details class="details-specimen">
            <summary class="details-specimen__summary">
              <span class="details-specimen__summary-text">Summary</span>
              <span class="details-specimen__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
                  <path class="details-specimen__icon-plus" d="M12 5V19"></path>
                  <path d="M5 12H19"></path>
                </svg>
              </span>
            </summary>
            <p class="details-specimen__body">Body</p>
          </details>
          <details class="details-specimen" open>
            <summary class="details-specimen__summary">
              <span class="details-specimen__summary-text">Summary</span>
              <span class="details-specimen__icon" aria-hidden="true">
                <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
...
export const Documentation = () => createDetailsDocumentation();
