...
.blockquote--right {
  ...
  align-items: flex-end;
      ...
      <pre><code>/* Typography */
--components-blockquote-quote-font-size    Mobile: 0.75rem / 12px   &rarr;   Widescreen: 1.5rem / 24px
--components-blockquote-quote-line-height  Mobile: 1.25rem / 20px   &rarr;   Widescreen: 2.25rem / 36px
--components-blockquote-cite-font-size     Mobile: 0.625rem / 10px  &rarr;   Widescreen: 1.25rem / 20px
--components-blockquote-cite-line-height   Mobile: 1rem / 16px      &rarr;   Widescreen: 1.875rem / 30px

/* Spacing */
--xl   Mobile: 1rem / 16px     &rarr;   Widescreen: 2rem / 32px
--md   Mobile: 0.5rem / 8px    &rarr;   Widescreen: 1rem / 16px
