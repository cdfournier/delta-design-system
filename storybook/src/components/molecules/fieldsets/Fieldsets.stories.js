  ...
  return `
    <div class="delta-docs">
      ...
      <div class="component-demo">
        <div class="fieldset-specimen-row">
          <div class="fieldset">
            <label for="demo-text">Label</label>
            <input type="text" id="demo-text" class="input-text" placeholder="Placeholder">
            <div class="message">Message text provides context or validation feedback</div>
          </div>
          <div class="fieldset">
            <label for="demo-select">Label</label>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Message text — default</td>
            <td><code>text/default</code></td>
            <td>#000000 (global/black)</td>
            <td>#FFFFFF (global/white)</td>
          </tr>
          <tr>
            <td>Message text — invalid</td>
            <td><code>status/invalid</code></td>
            <td>#C00C00</td>
            <td>#C00C00</td>
          </tr>
          <tr>
            <td>Message text — valid</td>
            <td><code>status/valid</code></td>
            <td>#007000</td>
            <td>#007000</td>
          </tr>
          <tr>
            <td>Message text — disabled</td>
            <td><code>status/disabled</code></td>
            <td>#808080</td>
            <td>#808080</td>
          </tr>
          <tr>
            <td>Message text — read-only</td>
      ...
      <ul>
        ...
        <li><strong>Use placeholders for format examples:</strong> Show an example value (e.g. "<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="016f606c64416479606c716d642f626e6c">[email&#160;protected]</a>") rather than repeating the label or providing instructions. Placeholders disappear on input and cannot replace visible labels.</li>
...
--components-input-checkbox-font-size     1rem / 16px
--components-input-checkbox-line-height   1.25rem / 20px
...
--components-input-text-padding-gap       0.25rem / 4px
--components-input-checkbox-padding       0.125rem / 2px
--components-input-checkbox-padding-gap   0.5rem / 8px
--components-input-switch-padding         0.25rem / 4px
--components-input-switch-padding-gap     0.5rem / 8px

/* Border-radius */
--components-input-text-border-radius     0.25rem / 4px
--input-checkbox-border-radius            0.25rem / 4px
--components-input-switch-border-radius   1rem / 16px
...
--status-read-only     Light: #333333   Dark: #333333</code></pre>
      ...
      <ul>
        ...
        <li><a href="https://developer.mozilla.org/" target="_blank">MDN Web Docs</a> — HTML, CSS, ARIA, and JavaScript documentation</li>
      </ul>
    </div>
  `;
};
