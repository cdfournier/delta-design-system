...
export const Documentation = () => {
  return `
    <div class="delta-docs">
      ...
      <div class="component-demo">
        <div class="message message-promo" style="position: relative; min-height: 200px;">
          <button class="message-close" aria-label="Close">
            ${closeIcon}
          </button>
          <div class="message-content">
            <h2 style="margin: 0 0 var(--spacing-sm) 0;">Promo banner</h2>
            <p style="margin: 0;">This is a banner for announcements, offers, or feature highlights. Uses Content component</p>
          </div>
        </div>
      </div>
      ...
      <div class="component-demo">
        <div class="message message-confirmation" role="alertdialog" aria-labelledby="confirm-specimen">
          <span id="confirm-specimen" class="message-text">Confirmation message</span>
...
--components-button-border-radius   2rem / 32px
