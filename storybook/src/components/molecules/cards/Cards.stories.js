...
export const Documentation = () => {
  return `
    <div class="delta-docs">
      ...
      <div class="component-demo" style="display: flex; gap: var(--spacing-xl); flex-wrap: wrap;">
        <article class="card card-vertical" style="max-width: var(--components-card-vertical-min-width);">
          <figure class="figure">
            <img src="${cardImage}" alt="Placeholder image">
          </figure>
          <div class="content">
            <h3>Card heading</h3>
            <p>Supporting body text that provides context and information about this card.</p>
          </div>
        </article>
        <article class="card card-vertical" style="max-width: var(--components-card-vertical-min-width);">
          <figure class="figure">
      ...
      <div class="component-demo" style="display: flex; flex-direction: column; gap: var(--spacing-xl);">
        <article class="card card-horizontal">
          ...
          <div class="content">
            ...
            <p>Figure on the left, content on the right. This is the default horizontal layout.</p>
          </div>
        </article>
        <article class="card card-horizontal card-horizontal-reverse">
          <figure class="figure">
            <img src="${cardImage}" alt="Placeholder image">
          </figure>
          <div class="content">
            <h3>Reversed horizontal card</h3>
            <p>Content on the left, figure on the right. Use sparingly for visual rhythm.</p>
          </div>
        </article>
      </div>
