...
export const Documentation = () => {
  return `
    <div class="delta-docs">
      ...
      <div class="component-demo">
        <div class="feedback-specimen-row">
          <div class="feedback meter">
            <div class="feedback-label">Label</div>
            <div class="meter-bar">
              <div class="feedback-bar">
                <div class="feedback-value optimum" style="width: 40%"></div>
              </div>
            </div>
          </div>
          <div class="feedback meter">
            ...
            <div class="meter-bar">
              <div class="feedback-bar">
                <div class="feedback-value low" style="width: 15%"></div>
              </div>
            </div>
          </div>
          <div class="feedback meter">
            ...
            <div class="meter-bar">
              <div class="feedback-bar">
                <div class="feedback-value high" style="width: 80%"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Label padding-bottom, Value padding-top</td>
            <td><code>sm</code></td>
            <td>0.25rem / 4px</td>
            <td>0.5rem / 8px</td>
          </tr>
      ...
      <p><strong>Light/Dark mode behavior:</strong> Text colors adapt through the <code>text/default</code> token (black in light mode, white in dark mode). Bar track and fill colors remain the same in both modes for clarity and immediate recognition.</p>
