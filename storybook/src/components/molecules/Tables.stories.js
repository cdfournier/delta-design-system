...
export const Documentation = () => {
  return `
    <div class="delta-docs">
      ...
      <div class="component-demo" style="overflow-x: auto;">
        <table class="table-specimen">
          <thead>
            <tr>
              <th>Date</th>
              <th>Category</th>
              <th class="table-cell-right">Cost</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td>yyyy/mm/dd</td>
              <td>Category</td>
              <td class="table-cell-right"><span class="table-currency">$</span>000.00</td>
            </tr>
            <tr>
              <td>yyyy/mm/dd</td>
              <td>Category</td>
              <td class="table-cell-right"><span class="table-currency">$</span>00.00</td>
            </tr>
            <tr>
              <td>yyyy/mm/dd</td>
              <td>Category</td>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Row bottom border</td>
            <td><code>global/gray-medium</code></td>
            <td>#CCCCCC</td>
            <td>#CCCCCC</td>
          </tr>
          <tr>
            <td>Cell text (all variants)</td>
      ...
      <h3>HTML</h3>
      <pre><code>&lt;!-- Basic data table --&gt;
&lt;div class="table-wrapper"&gt;
  &lt;table class="table"&gt;
    &lt;caption class="visually-hidden"&gt;Recent expenses&lt;/caption&gt;
