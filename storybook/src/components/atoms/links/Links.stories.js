  ...
  return `
    <div class="delta-docs">
      ...
      <div class="component-demo">
        <a href="#" class="demo-link link-p" onclick="return false;">
          Example link
      ...
      <div class="component-demo">
        <a href="#" class="demo-link link-small" onclick="return false;">
          Small size link
          <svg viewBox="0 0 16 16" aria-hidden="true">
            <path d="M8 0L6.59 1.41 12.17 7H0v2h12.17l-5.58 5.59L8 16l8-8z"/>
          </svg>
      ...
      <div class="component-demo">
        <a href="#" class="demo-link link-fine" onclick="return false;">
          Fine size link
          <svg viewBox="0 0 16 16" aria-hidden="true">
            <path d="M8 0L6.59 1.41 12.17 7H0v2h12.17l-5.58 5.59L8 16l8-8z"/>
          </svg>
      ...
      <div class="component-demo">
        <a href="#" class="demo-link link-p" style="gap: var(--spacing-sm); color: var(--text-link-hover);" onclick="return false;">
          Hover state link
          <svg viewBox="0 0 16 16" aria-hidden="true">
            <path d="M8 0L6.59 1.41 12.17 7H0v2h12.17l-5.58 5.59L8 16l8-8z"/>
          </svg>
