  ...
  return `
    <div class="delta-docs">
      ...
      <div class="component-demo">
        <label for="demo-input">Email address</label>
        <input type="email" id="demo-input" class="input-text" placeholder="Enter your email">
        <p class="message">We'll never share your email with anyone else.</p>
      </div>
      ...
      <div class="component-demo">
        <label for="text-demo">Full name</label>
        <input type="text" id="text-demo" class="input-text" placeholder="Enter your name">
      </div>
      ...
      <div class="component-demo">
        <label for="select-demo">Country</label>
        <select id="select-demo" class="input-select">
      ...
      <div class="component-demo">
        ...
        <div class="radio-group">
          <input type="radio" id="radio-2" name="radio-demo">
      ...
      <div class="component-demo">
        <div class="switch-group">
          <input type="checkbox" id="switch-demo" role="switch">
          <label for="switch-demo">Enable notifications</label>
        </div>
      </div>
      ...
      <div class="component-demo">
        ...
        <input type="password" id="password-demo" class="input-text" placeholder="Enter your password">
      </div>
      ...
      <div class="component-demo">
        <p class="message">Helper text provides additional guidance.</p>
        <p class="message valid">This input is valid.</p>
        <p class="message invalid">This input contains an error.</p>
      </div>
      ...
      <div class="component-demo">
        <input type="text" class="input-text" placeholder="Default state">
      </div>
      ...
      <div class="component-demo">
        <input type="text" class="input-text" placeholder="Disabled state" disabled>
      </div>
      ...
      <div class="component-demo">
        <input type="text" class="input-text" value="Read-only value" readonly>
      </div>
      ...
      <div class="component-demo">
        <input type="email" class="input-text valid" value="user@example.com">
        <p class="message valid">Email address is valid</p>
      </div>
      ...
      <div class="component-demo">
        <input type="email" class="input-text invalid" value="invalid-email">
        <p class="message invalid">Please enter a valid email address</p>
      </div>
