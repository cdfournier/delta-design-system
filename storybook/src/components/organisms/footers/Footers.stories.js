...
export const Documentation = () => {
  return `
    <div class="delta-docs">
        ...
        <footer>
          <div class="group">
            <div class="row">
              ...
              <div class="brand">
                <div class="the-delta-design-system-mark">
                  <svg class="logo" viewBox="0 0 1024 796" aria-hidden="true">
      ...
      <h2>States</h2>
      <ul>
        <li><strong>Default:</strong> The footer renders with a light gray group container background, black text for the heading and fine print, and red link text. The color mode toggle defaults to the light mode position.</li>
        <li><strong>Hover:</strong> Navigation links change color on hover: <code>text/link</code> (#FF5247) transitions to <code>brand/secondary</code> (#003442) in light mode; white transitions to <code>brand/primary</code> (#FF5247) in dark mode.</li>
      ...
      <h2>Typography</h2>
      <p>Navigation links use the <code>small</code> type token with bold weight. The heading uses the <code>h4</code> type token. Fine print uses the <code>fine</code> token. All text tokens scale responsively between mobile and widescreen breakpoints.</p>
...
/* Sizing */
--components/width/by-font-size/h1   Mobile: 3.125rem / 50px   →   Widescreen: 4.5rem / 72px
