    ...
    <div class="delta-docs">
      ...
      <div class="component-demo">
        <div class="banner-bg-image">
          <img src="${cardPlaceholder}" alt="" class="banner-bg-image-img">
          <div class="banner-overlay"></div>
          <div class="banner-bg-content">
            <h1 class="banner-title">Title Heading</h1>
      ...
      <div class="component-demo">
        <div class="banner-split">
          <div class="banner-split-figure">
            <img src="${cardPlaceholder}" alt="Placeholder image" class="banner-split-img">
          </div>
          <div class="banner-split-content">
            <h2 class="banner-split-heading">Heading</h2>
            <p class="banner-split-body">Body</p>
          </div>
        </div>
      </div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Container padding-left, padding-right</td>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>Vertical — padding-top, padding-bottom</td>
            <td><code>xl</code></td>
            <td>1rem / 16px</td>
            <td>2rem / 32px</td>
          </tr>
      ...
      <ul>
        ...
        <li><strong>Choose images carefully:</strong> Images should reinforce the message, not distract from it; for Background image, confirm readability with real imagery before finalizing</li>
      </ul>
      ...
      <div class="do-dont-grid">
        <div class="do-section">
          ...
          <p>Verify layout and contrast with actual images and copy before finalizing. Placeholder images often mask contrast and cropping problems.</p>

          <p><strong>Design mobile-first</strong></p>
          <p>Confirm that banners content is readable and impactful on small screens before scaling up. Content that feels sparse on mobile often works well at widescreen.</p>
        </div>
