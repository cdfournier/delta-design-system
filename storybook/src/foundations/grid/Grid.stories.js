...
export const Documentation = () => {
  return `
    <div class="delta-docs">
      ...
      <ul>
        <li><strong>3 columns:</strong> 25% width (3 &divide; 12 = 0.25)</li>
        <li><strong>6 columns:</strong> 50% width (6 &divide; 12 = 0.50)</li>
        <li><strong>8 columns:</strong> 66.67% width (8 &divide; 12 &asymp; 0.667)</li>
        <li><strong>12 columns:</strong> 100% width (12 &divide; 12 = 1.00)</li>
      </ul>
      ...
      <div class="component-demo">
        <div class="layout-demo">
          <div class="grid-column" style="flex: 0 0 calc(50% - var(--spacing-xl) / 2);">6 columns</div>
          <div class="grid-column" style="flex: 0 0 calc(50% - var(--spacing-xl) / 2);">6 columns</div>
        </div>
      </div>
      ...
      <div class="component-demo">
        <div class="layout-demo">
          <div class="grid-column" style="flex: 0 0 calc(33.333% - var(--spacing-xl) * 2 / 3);">4 columns</div>
          <div class="grid-column" style="flex: 0 0 calc(33.333% - var(--spacing-xl) * 2 / 3);">4 columns</div>
          <div class="grid-column" style="flex: 0 0 calc(33.333% - var(--spacing-xl) * 2 / 3);">4 columns</div>
        </div>
      </div>
      ...
      <div class="component-demo">
        <div class="layout-demo">
          <div class="grid-column" style="flex: 0 0 calc(25% - var(--spacing-xl) * 3 / 4);">3 columns</div>
          <div class="grid-column" style="flex: 0 0 calc(25% - var(--spacing-xl) * 3 / 4);">3 columns</div>
          <div class="grid-column" style="flex: 0 0 calc(25% - var(--spacing-xl) * 3 / 4);">3 columns</div>
          <div class="grid-column" style="flex: 0 0 calc(25% - var(--spacing-xl) * 3 / 4);">3 columns</div>
        </div>
      ...
      <div class="component-demo">
        <div class="layout-demo">
          <div class="grid-column" style="flex: 0 0 calc(66.667% - var(--spacing-xl) / 2);">8 columns (main content)</div>
          <div class="grid-column" style="flex: 0 0 calc(33.333% - var(--spacing-xl) / 2);">4 columns (sidebar)</div>
        </div>
      </div>
      ...
      <div class="component-demo">
        <div class="layout-demo">
          <div class="grid-column" style="flex: 0 0 calc(58.333% - var(--spacing-xl) / 2);">7 columns (golden wide)</div>
          <div class="grid-column" style="flex: 0 0 calc(41.667% - var(--spacing-xl) / 2);">5 columns (golden narrow)</div>
        </div>
      </div>
      ...
      <div class="component-demo">
        <div class="layout-demo">
          <div class="grid-column" style="flex: 0 0 66.667%; margin: 0 auto;">8 columns centered</div>
        </div>
      </div>
...
.col-span-3  { grid-column: span 3; }   /* 25% &mdash; quarter */
.col-span-4  { grid-column: span 4; }   /* 33.33% &mdash; third */
.col-span-6  { grid-column: span 6; }   /* 50% &mdash; half */
.col-span-8  { grid-column: span 8; }   /* 66.67% &mdash; two-thirds */
.col-span-12 { grid-column: span 12; }  /* 100% &mdash; full width */
...
--grid-columns-widescreen: 12        /* Presentation layer &mdash; also architecture layer */
...
md    Mobile/Tablet: 0.5rem / 8px   &rarr;   Widescreen: 1rem / 16px</code></pre>
