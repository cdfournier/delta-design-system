    ...
    <div class="delta-docs">
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h2-font-size); line-height: var(--h2-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox jumps over the lazy dog</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Montserrat', sans-serif; font-size: var(--p-font-size); line-height: var(--p-line-height); font-weight: 400; margin: 0 0 var(--spacing-md); color: var(--text-default);">The quick brown fox jumps over the lazy dog &mdash; Regular</p>
          <p style="font-family: 'Montserrat', sans-serif; font-size: var(--p-font-size); line-height: var(--p-line-height); font-weight: 700; margin: 0; color: var(--text-default);">The quick brown fox jumps over the lazy dog &mdash; Bold</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h1-title-font-size); line-height: var(--h1-title-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h1-title-font-size); line-height: var(--h1-title-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox</p>
          <p style="font-family: 'Montserrat', sans-serif; font-size: var(--h1-title-p-font-size); line-height: var(--h1-title-p-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The first paragraph after an h1 title receives special styling with increased font size for emphasis and improved visual hierarchy.</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h1-font-size); line-height: var(--h1-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h2-font-size); line-height: var(--h2-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h3-font-size); line-height: var(--h3-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h4-font-size); line-height: var(--h4-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Ovo', Georgia, serif; font-size: var(--h5-font-size); line-height: var(--h5-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Montserrat', sans-serif; font-size: var(--p-font-size); line-height: var(--p-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox jumps over the lazy dog. Typography expresses hierarchy and enables improved consumption of content.</p>
        </div>
        <div class="type-details">Montserrat Regular &nbsp;&bull;&nbsp; Mobile: 16px / 24px lh &nbsp;&bull;&nbsp; Widescreen: 24px / 36px lh</div>
      </div>

      <div class="type-specimen">
        <div class="type-specimen-header">List</div>
        <div class="type-specimen-example">
          <ul style="font-family: 'Montserrat', sans-serif; font-size: var(--list-font-size); line-height: var(--list-line-height); font-weight: 400; margin: 0 0 0 var(--spacing-xxxl); color: var(--text-default);">
        ...
        <div class="type-details">Montserrat Regular &nbsp;&bull;&nbsp; Mobile: 16px / 24px lh &nbsp;&bull;&nbsp; Widescreen: 24px / 40px lh</div>
      </div>

      <div class="type-specimen">
        <div class="type-specimen-header">Small</div>
        <div class="type-specimen-example">
          <p style="font-family: 'Montserrat', sans-serif; font-size: var(--small-font-size); line-height: var(--small-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox jumps over the lazy dog. Typography expresses hierarchy and enables improved consumption of content.</p>
        </div>
      ...
      <div class="type-specimen">
        ...
        <div class="type-specimen-example">
          <p style="font-family: 'Montserrat', sans-serif; font-size: var(--fine-font-size); line-height: var(--fine-line-height); font-weight: 400; margin: 0; color: var(--text-default);">The quick brown fox jumps over the lazy dog. Typography expresses hierarchy and enables improved consumption of content.</p>
        </div>
...
&lt;small&gt;Caption or helper text.&lt;/small&gt;
&lt;small class="fine"&gt;Legal or micro-copy text.&lt;/small&gt;
...
h1.title + p {
  ...
  font-size: var(--h1-title-p-font-size);
  line-height: var(--h1-title-p-line-height);
}
...
.heading-link:hover {
  color: var(--text-link);
      ...
      <h3>JavaScript</h3>
      <pre><code>/* Heading link &mdash; copy anchor URL to clipboard */
document.querySelectorAll('.heading-link-icon').forEach(button => {
  button.addEventListener('click', async (e) => {
    ...
    try {
      ...
      <pre><code>/* Headings */
--h1-title/font-size     Mobile: 3.125rem / 50px   &rarr;   Widescreen: 5rem / 80px
--h1-title/line-height   Mobile: 3.5rem / 56px     &rarr;   Widescreen: 6.25rem / 100px
--h1-title+p/font-size   Mobile: 1rem / 16px       &rarr;   Widescreen: 2rem / 32px
--h1-title+p/line-height Mobile: 1.75rem / 28px    &rarr;   Widescreen: 3.5rem / 56px
--h1/font-size           Mobile: 3.125rem / 50px   &rarr;   Widescreen: 4.5rem / 72px
--h1/line-height         Mobile: 3.5rem / 56px     &rarr;   Widescreen: 5.625rem / 90px
--h2/font-size           Mobile: 2.375rem / 38px   &rarr;   Widescreen: 3.75rem / 60px
--h2/line-height         Mobile: 2.625rem / 42px   &rarr;   Widescreen: 4.625rem / 74px
--h3/font-size           Mobile: 1.75rem / 28px    &rarr;   Widescreen: 3.125rem / 50px
--h3/line-height         Mobile: 2rem / 32px       &rarr;   Widescreen: 3.875rem / 62px
--h4/font-size           Mobile: 1.5rem / 24px     &rarr;   Widescreen: 2.625rem / 42px
--h4/line-height         Mobile: 1.875rem / 30px   &rarr;   Widescreen: 3.25rem / 52px
--h5/font-size           Mobile: 1.25rem / 20px    &rarr;   Widescreen: 2rem / 32px
--h5/line-height         Mobile: 1.625rem / 26px   &rarr;   Widescreen: 2.5rem / 40px

/* Body and UI */
--p/font-size            Mobile: 1rem / 16px       &rarr;   Widescreen: 1.5rem / 24px
--p/line-height          Mobile: 1.5rem / 24px     &rarr;   Widescreen: 2.25rem / 36px
--list/font-size         Mobile: 1rem / 16px       &rarr;   Widescreen: 1.5rem / 24px
--list/line-height       Mobile: 1.5rem / 24px     &rarr;   Widescreen: 2.5rem / 40px
--small/font-size        Mobile: 0.75rem / 12px    &rarr;   Widescreen: 1.25rem / 20px
--small/line-height      Mobile: 1.25rem / 20px    &rarr;   Widescreen: 1.875rem / 30px
--fine/font-size         Mobile: 0.625rem / 10px   &rarr;   Widescreen: 1rem / 16px
--fine/line-height       Mobile: 1rem / 16px       &rarr;   Widescreen: 1.5rem / 24px</code></pre>
