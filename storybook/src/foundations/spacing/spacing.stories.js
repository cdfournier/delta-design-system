function createSpacingDocumentation() {
  return `
    <article class="delta-docs">
      ...
      <div class="spacing-specimen">
        ...
        <div class="spacing-visual">
          ...
          <div class="spacing-bar" style="width: var(--spacing-sm);"></div>
          <span class="spacing-value">0.25rem / 4px</span>
        </div>
        <div class="spacing-visual">
          <span class="spacing-label">md</span>
          <div class="spacing-bar" style="width: var(--spacing-md);"></div>
          <span class="spacing-value">0.5rem / 8px</span>
        </div>
        <div class="spacing-visual">
          <span class="spacing-label">lg</span>
          <div class="spacing-bar" style="width: var(--spacing-lg);"></div>
        ...
        <div class="spacing-visual">
          <span class="spacing-label">xxl</span>
          <div class="spacing-bar" style="width: var(--spacing-xxl);"></div>
          <span class="spacing-value">1.5rem / 24px</span>
        </div>
        <div class="spacing-visual">
          <span class="spacing-label">xxxl</span>
          <div class="spacing-bar" style="width: var(--spacing-xxxl);"></div>
      ...
      <p>The spacing system uses rem units, maintaining consistent relationships with typography as content scales. When users adjust their browser's base font size, spacing scales proportionally with text &mdash; ensuring layouts maintain their visual rhythm for users who customise their reading experience.</p>
      ...
      <div class="radius-grid">
        <div class="radius-item">
          <div class="radius-specimen" style="border-radius: var(--border-radius-xs);"></div>
          <div class="radius-label">xs &mdash; 2px</div>
        </div>
        <div class="radius-item">
          <div class="radius-specimen" style="border-radius: var(--border-radius-sm);"></div>
          <div class="radius-label">sm &mdash; 4px</div>
        </div>
        <div class="radius-item">
          <div class="radius-specimen" style="border-radius: var(--border-radius-md);"></div>
          <div class="radius-label">md &mdash; 8px</div>
        </div>
        <div class="radius-item">
          <div class="radius-specimen" style="border-radius: var(--border-radius-lg);"></div>
          <div class="radius-label">lg &mdash; 16px</div>
        </div>
        <div class="radius-item">
          <div class="radius-specimen" style="border-radius: var(--border-radius-xl);"></div>
          <div class="radius-label">xl &mdash; 24px</div>
        </div>
        <div class="radius-item">
          <div class="radius-specimen" style="border-radius: var(--border-radius-xxl);"></div>
          <div class="radius-label">xxl &mdash; 32px</div>
        </div>
        <div class="radius-item">
          <div class="radius-specimen" style="border-radius: var(--border-radius-round);"></div>
          <div class="radius-label">round &mdash; 100px</div>
        </div>
      </div>
      ...
      <p><code>border-radius/round</code> is a fixed value and does not scale responsively.</p>
      ...
      <ul>
        <li><strong>Minimum touch target:</strong> 44×44px (WCAG 2.1 Level AA)</li>
        <li><strong>Recommended touch target:</strong> 48×48px for improved usability</li>
      ...
      <p><strong>xxxl:</strong> Large spacing between major sections. Use for separating distinct content areas or creating strong visual breaks.</p>
      ...
      <ul>
        ...
        <li><strong>Section breaks:</strong> <code>xxxl</code> (2rem / 32px mobile, 4rem / 64px widescreen) between major content areas</li>
...
--border-radius-round  Fixed:  6.25rem / 100px   →   Fixed: 6.25rem / 100px</code></pre>
...
export const Documentation = () => createSpacingDocumentation();
