import CJS_COMPAT_NODE_URL_zpd28dwlgkl from 'node:url';
import CJS_COMPAT_NODE_PATH_zpd28dwlgkl from 'node:path';
import CJS_COMPAT_NODE_MODULE_zpd28dwlgkl from "node:module";

var __filename = CJS_COMPAT_NODE_URL_zpd28dwlgkl.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_zpd28dwlgkl.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_zpd28dwlgkl.createRequire(import.meta.url);
...
import {
  toEstree
} from "../_node-chunks/chunk-3YLOWNHZ.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-A4A5C3PL.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-KIOKJLL5.js";
import {
  detectPnp
} from "../_node-chunks/chunk-7LSJFCTL.js";
import "../_node-chunks/chunk-PIDFT6ZG.js";
import {
  StorybookError
} from "../_node-chunks/chunk-QC7GMHH3.js";
import {
  telemetry
} from "../_node-chunks/chunk-QP2Y5Q7Y.js";
import "../_node-chunks/chunk-FAKHOYIA.js";
import {
...
} from "../_node-chunks/chunk-WF46L34H.js";
import "../_node-chunks/chunk-DIZA4FNE.js";
import "../_node-chunks/chunk-L6BKW53O.js";
import {
  require_pretty_hrtime
} from "../_node-chunks/chunk-T5JM3LY2.js";
import "../_node-chunks/chunk-EHJL3FYZ.js";
import "../_node-chunks/chunk-SACCCBCF.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-O6AYJK6F.js";
import "../_node-chunks/chunk-CH6VZ5WY.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-C6KVY6VB.js";
import {
  dirname,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-YKPPKK2X.js";
import {
  slash
} from "../_node-chunks/chunk-QTPFQ47S.js";
import "../_node-chunks/chunk-I2YONGWX.js";
import {
  Tag
} from "../_node-chunks/chunk-R5K6MN7N.js";
import {
  require_dist
} from "../_node-chunks/chunk-QECSY5M2.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-XLB3DI6A.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-4BMBIAN3.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-F23T7FYH.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-SJCQOOR2.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-WZGW3ILF.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-Y7ZQT3GG.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-WZGW3ILF.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
