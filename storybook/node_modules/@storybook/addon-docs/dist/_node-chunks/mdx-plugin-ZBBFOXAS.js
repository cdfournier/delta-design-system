...
import {
  compile
} from "./chunk-HXYR2M66.js";
import "./chunk-CMSOXNTK.js";
import "./chunk-UVUJV6J2.js";
import {
  __commonJS,
  __toESM
} from "./chunk-BMN5ONMR.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-VAUWZYVZ.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-XFB3ZP3Z.js")).default;
  return {
